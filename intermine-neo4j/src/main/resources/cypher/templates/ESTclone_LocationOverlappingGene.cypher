...
(est_datasets)-[:dataSource]-(est_datasets_datasource :DataSource),
(est)-[:overlappingESTSets]-(est_overlappingestsets :OverlappingESTSet),
(est_overlappingestsets)-[:chromosomeLocation]-(est_overlappingestsets_chromosomelocation :Location),
